...
impl Sheet {
    ...
    pub fn generate_gcode(&self, laser_power: u16, feedrate: u16, name: &str)->String {
        ...
        builder.comment_block(format!("Feed: {}mm/min; Power: {}%", feedrate, (laser_power as f32) / 10.0));
        ...
        for (model, mt) in self.entities.values() {
            model.generate_gcode(mt, &mut builder, laser_power, feedrate);
        }
